...
namespace CapaPresentacion
{
    public partial class FrmListarPeliculas : Form
    {
        ...
        {
            dlistado1.DataSource = CNPeliculas.BuscarGenero(txtbuscar1.Text);
        }

        public void BuscarDuracion()
        {
            dlistado1.DataSource = CNPeliculas.BuscarDuracion(txtbuscar1.Text);
        }

        public void BuscarClasificacion()
        {
            dlistado1.DataSource = CNPeliculas.BuscarClasificacion(txtbuscar1.Text);
        }

        public void BuscarIdioma()
        {
            dlistado1.DataSource = CNPeliculas.BuscarIdioma(txtbuscar1.Text);
        }
